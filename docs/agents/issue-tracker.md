...
Run `gh` outside the Codex sandbox. GitHub operations may require network access and authentication that are unavailable inside the sandbox; request or use approved escalated execution for those commands.
