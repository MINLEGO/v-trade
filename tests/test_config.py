...
class ConfigTests(unittest.TestCase):
    ...
    def test_resolved_model_and_scheduling_decisions_are_frozen(self) -> None:
        ...
        for model in models.values():
            ...
            self.assertEqual(model["reasoning_effort_policy"], "provider_default")
    ...
    def test_openrouter_owner_price_bounds_are_frozen(self) -> None:
        ...
        self.assertEqual(deepseek["estimated_max_cost_micros"], 11_000)
        self.assertEqual(
            deepseek["provider_max_price"],
            {"prompt": "0.09", "completion": "0.18", "request": "0"},
        )
        mimo = models["xiaomi/mimo-v2.5-pro"]
        self.assertEqual(mimo["estimated_max_cost_micros"], 40_000)
        self.assertEqual(
            mimo["provider_max_price"],
            {"prompt": "0.348", "completion": "0.696", "request": "0"},
        )
