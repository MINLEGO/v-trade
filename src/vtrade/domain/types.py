...
# ---------------------------------------------------------------------------
# vtrade-binary-market-v1
# ---------------------------------------------------------------------------
#
# The original classes above are still consumed by the pre-Kalshi execution
# code.  The types below are the new semantic seam.  They intentionally do not
# carry venue token/condition identifiers: a market owns its two outcomes.
